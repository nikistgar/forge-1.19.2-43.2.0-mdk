...
public class AltarRecipe implements Recipe<SimpleContainer> {
    ...
    public AltarRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<AltarRecipe> {
        ...
        @Override
        public @Nullable AltarRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new AltarRecipe(id, output, inputs);
        }
